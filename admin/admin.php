...
function wp3cxc2c_admin_menu() {
	...
	$edit = add_submenu_page( 'wp3cxc2c',
		__( 'Edit Click To Talk item', '3cx-clicktotalk' ),
		__( 'Click To Talk items', '3cx-clicktotalk' ),
		'wp3cxc2c_read_clicktotalk_forms', 'wp3cxc2c',
	...
	$addnew = add_submenu_page( 'wp3cxc2c',
		__( 'Add New Click To Talk item', '3cx-clicktotalk' ),
...
<h1 class="wp-heading-inline"><?php
	echo esc_html( __( 'Click To Talk items', '3cx-clicktotalk' ) );
?></h1>
...
<form method="get" action="">
	...
	<?php $list_table->search_box( __( 'Search Click To Talk item', '3cx-clicktotalk' ), 'wp3cxc2c-clicktotalk' ); ?>
...
function wp3cxc2c_admin_updated_message() {
	...
	if ( 'created' == $_REQUEST['message'] ) {
		$updated_message = __( "Click To Talk item created.", '3cx-clicktotalk' );
	} elseif ( 'saved' == $_REQUEST['message'] ) {
		$updated_message = __( "Click To Talk item saved.", '3cx-clicktotalk' );
	} elseif ( 'deleted' == $_REQUEST['message'] ) {
		$updated_message = __( "Click To Talk item deleted.", '3cx-clicktotalk' );
	}
	...
	if ( 'failed' == $_REQUEST['message'] ) {
		$updated_message = __( "There was an error saving the Click To Talk item.",
			'3cx-clicktotalk' );
...
<p><?php
	/* translators: 1: version of 3CX Click To Talk , 2: version of WordPress, 3: URL */
	echo sprintf( __( '<strong>3CX Click To Talk %1$s requires WordPress %2$s or higher.</strong> Please <a href="%3$s">update WordPress</a> first.', '3cx-clicktotalk' ), WP3CXC2C_VERSION, WP3CXC2C_REQUIRED_WP_VERSION, admin_url( 'update-core.php' ) );
?></p>
</div>
<?php
}
...
function wp3cxc2c_not_allowed_to_edit() {
	...
	$message = __( "You are not allowed to edit this Click To Talk item.",
		'3cx-clicktotalk' );
